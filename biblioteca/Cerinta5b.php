...
<style>
    ...
    <body>
        <h1>5.b) Să se găsească titlul și autorii cărților cu mai mulți autori.</h1>
        <?php
...
<button class="NEXT" 	
	onclick="window.location.href = 'http://127.0.0.1/biblioteca/Cerinta6a.php';">NEXT
	</button>
</p>
</html>